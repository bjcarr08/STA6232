...
formattable(
  ...
  align = "l",
  list(
    outlier = color_tile("#F9F8F1", "plum1"),
    n = color_tile("plum1", "#F9F8F1")
    )
  )
...
classpackage::cooks(m1, show.threshold = T, label = F) +
  geom_point() + 
  ylim(NA, 0.02) +
  geom_point(aes(x = new.x[1], y = new.y[1]), size = 3, shape = 21, color = "plum3", fill = "plum1") +
  geom_point(aes(x = new.x[2], y = new.y[2]), size = 3, shape = 21, color = "plum3", fill = "plum1") +
  geom_point(aes(x = new.x[3], y = new.y[3]), size = 3, shape = 21, color = "plum3", fill = "plum1") +
  geom_point(aes(x = new.x[4], y = new.y[4]), size = 3, shape = 21, color = "plum3", fill = "plum1") +
  geom_point(aes(x = new.x[5], y = new.y[5]), size = 3, shape = 21, color = "plum3", fill = "plum1") +
  geom_point(aes(x = new.x[6], y = new.y[6]), size = 3, shape = 21, color = "plum3", fill = "plum1") +
  geom_point(aes(x = new.x[7], y = new.y[7]), size = 3, shape = 21, color = "plum3", fill = "plum1") +
